  ...
  const notificationsArray = [
    {
      ...
      title: (
        <p className='media-heading'>
          <span className='fw-bolder'>Happy Birthday! 🎉</span>Sam!
        </p>
      )
    },
    {
    ...
    },
    {
      ...
      title: (
        <p className='media-heading'>
          <span className='fw-bolder'>New Appointment 👋</span>
        </p>
      )
    },
    {
    ...
    },
    {
      ...
      color: 'light-success',
      subtitle: 'Last month billing report generated',
      title: (
        <p className='media-heading'>
          <span className='fw-bolder'>Billing report</span>&nbsp;generated
        </p>
      )
    },
    {
