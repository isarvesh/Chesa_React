...
const options = [
  { value: 'Dianna', label: 'Dianna', avatar: avatar1 },
  { value: 'Jasmine', label: 'Jasmine', avatar: avatar2 },
  { value: 'Khushbo', label: 'Khushbo', avatar: avatar3 },
  { value: 'Shruti', label: 'Shruti', avatar: avatar4 },
  { value: 'Julie', label: 'Julie', avatar: avatar5 },
  { value: 'Cheryl', label: 'Cheryl', avatar: avatar6 }
]
        ...
        <ModalBody className='px-sm-5 mx-50 pb-4'>
          ...
          <div className='d-flex align-content-center justify-content-between flex-wrap'>
            <div className='d-flex align-items-center me-2'>
              ...
              <p className='fw-bolder mb-0'>Public to Chesa - Pixinvent</p>
            </div>
