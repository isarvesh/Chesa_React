...
const TaskSidebar = props => {
  ...
  const assigneeOptions = [
    { value: 'paula', label: 'Paula', img: img1 },
    { value: 'chandler', label: 'Chandler', img: img2 },
    { value: 'mallaika', label: 'Mallaika', img: img3 },
    { value: 'monica', label: 'Monica', img: img4 },
    { value: 'joey', label: 'Joey', img: img5 },
    { value: 'Rachel', label: 'Rachel', img: img6 }
  ]
