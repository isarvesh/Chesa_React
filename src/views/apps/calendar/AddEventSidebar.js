...
const AddEventSidebar = props => {
  ...
  const guestsOptions = [
    { value: 'Dianna', label: 'Dianna', avatar: img1 },
    { value: 'Jasmine', label: 'Jasmine', avatar: img2 },
    { value: 'Khushbo', label: 'Khushbo', avatar: img3 },
    { value: 'Shruti', label: 'Shruti', avatar: img4 },
    { value: 'Julie', label: 'Julie', avatar: img5 },
    { value: 'Cheryl', label: 'Cheryl', avatar: img6 }
  ]
