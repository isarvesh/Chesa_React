        ...
        <Row>
          <Col md='6' className='mb-1'>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Input placeholder='https://twitter.com/Sam' invalid={errors.twitter && true} {...field} />
              )}
            />
          ...
          <Col md='6' className='mb-1'>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Input placeholder='https://facebook.com/Sam' invalid={errors.facebook && true} {...field} />
              )}
            />
        ...
        <Row>
          <Col md='6' className='mb-1'>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Input placeholder='https://plus.google.com/Sam' invalid={errors.google && true} {...field} />
              )}
            />
          ...
          <Col md='6' className='mb-1'>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Input placeholder='https://linkedin.com/Sam' invalid={errors.linkedin && true} {...field} />
              )}
            />
